...
class FindElementByID():
    def locate_by_id(self):
        ...
        month_select_september = driver.find_element(By.ID, f'ctl00_MainContent_CalendarExtender_frmdate_month_2_0')
        month_select_september.click()
        time.sleep(2)

        for day_id_firstrow_sept in range(5, 7):
            date_select = driver.find_element(By.ID, f'ctl00_MainContent_CalendarExtender_frmdate_day_0_{day_id_firstrow_sept}')
            date_select.click()
            time.sleep(2)
